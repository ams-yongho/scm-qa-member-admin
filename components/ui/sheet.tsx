...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ...
      {...props}
    >
      {/* Fallback title for accessibility — real SheetTitle in SheetHeader overrides */}
...
export const SheetHeader = ({
  ...
  <div
    className={cn("flex flex-col space-y-1 px-6 py-4 border-b", className)}
    {...props}
  />
);
...
export const SheetFooter = ({
  ...
  <div
    className={cn(
      "sticky bottom-0 mt-auto flex flex-col-reverse gap-2 border-t bg-background px-6 py-3 sm:flex-row sm:justify-end",
      className,
    )}
    {...props}
  />
